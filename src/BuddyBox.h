...
static const unsigned int MAX_CHANNELS                  = 12;
...
static const unsigned int BAD_FRAME_THRESHOLD           = 100;
static const unsigned int OVERFLOW_SAMPLES              = 4096;
static const float SIGNAL_NOISE_THRESHOLD               = 0.1f;

static const unsigned int FRAME_DURATION                = 20000;    // 20000 us (50 hz)
static const unsigned int SEPARATOR_DURATION            = 375;      // 400 us
static const unsigned int CHANNEL_MIN_DURATION          = 500;      // 500 us
static const unsigned int CHANNEL_MAX_DURATION          = 1900;     // 1700 us
static const float SIGNAL_HIGH_FLOAT                    = 0.25f;    // Experimentally: 0.75f;
static const float SIGNAL_LOW_FLOAT                     = -0.75f;     // Experimentally: -0.23f;
